...
const disk7 = new Disk("https://upload.wikimedia.org/wikipedia/en/0/0f/Paradise_Lost_-_Icon.jpg",
    "Album", "Artiste", "Genre", ["Un", "Deux", "Trois", "Quatre"], "2022");

const disk9 = new Disk("https://upload.wikimedia.org/wikipedia/en/0/0f/Paradise_Lost_-_Icon.jpg",
    "Album", "Artiste", "Genre", ["Un", "Deux", "Trois", "Quatre"], "2022");

const disk8 = new Disk("https://upload.wikimedia.org/wikipedia/en/0/0f/Paradise_Lost_-_Icon.jpg",
    "Album", "Artiste", "Genre", ["Un", "Deux", "Trois", "Quatre"], "2022");

const disk10 = new Disk("https://upload.wikimedia.org/wikipedia/en/0/0f/Paradise_Lost_-_Icon.jpg",
    "Album", "Artiste", "Genre", ["Un", "Deux", "Trois", "Quatre"], "2022");

const disk11 = new Disk("https://upload.wikimedia.org/wikipedia/en/0/0f/Paradise_Lost_-_Icon.jpg",
    "Album", "Artiste", "Genre", ["Un", "Deux", "Trois", "Quatre"], "2022");




export const DATA = [disk1, disk2, disk3, disk4, disk5, disk6, disk7, disk8, disk9, disk10, disk11];